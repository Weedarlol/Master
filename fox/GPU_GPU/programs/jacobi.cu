...
__global__ void jacobiMid(double *data_gpu, double *data_gpu_tmp, int width, int height,
                        int slices_Leftover, int device_nr, int slices_compute, int elementsPerThread, int elementsLeftover,
                        int elementsPerThreadExtra, int elementsLeftoverExtra, int overlap_calc){
