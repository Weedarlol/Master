...
#SBATCH --job-name=width512_height512_depth512_iter10000_compare1_accel_GPU
#SBATCH --account=ec12
#SBATCH -p accel
...
#SBATCH --output=output/width512_height512_depth512_iter10000_compare1_accel.out
#SBATCH --error=error/width512_height512_depth512_iter10000_compare1_accel.err
...
nvcc -rdc=true main.cu programs/jacobi.cu ../../functions//global_functions_fox.o ../../functions//cuda_functions_fox.o -o out_width512_height512_depth512_iter10000_compare1_accel -L/../../usr/lib/x86_64-linux-gnu/libnccl.so -lnccl

./out_width512_height512_depth512_iter10000_compare1_accel 512 512 512 10000 1
