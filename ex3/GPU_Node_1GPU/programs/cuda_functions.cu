...
void initializeStreamsAndEvents(cudaStream_t streams[1], cudaEvent_t events[4], cudaEvent_t *startevent, cudaEvent_t *stopevent) {
...
void freeStreamsAndEvents(cudaStream_t streams[1], cudaEvent_t events[4], cudaEvent_t *startevent, cudaEvent_t *stopevent) {
